<?php 
require_once 'employe_list_script.php';
require_once 'employe_single_script.php';
 ?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <ul class="navbar-nav">
      <li class="nav-item active">Employés
        <ul class="submenu">
          ...
          <li><a class="nav-link" href="employe_list.php">Liste des employés</a></li>
        </ul>
      </li>
...
<table class="table">
  ...
  <tbody>
        ...
        <th><?php echo $employe['id'] ?></th>
        <th><?php echo $employe['name'] ?></th>  
        <th><?php echo $employe['firstname'] ?></th>
        <th><?php echo $employe['age'] ?></th>
        <th><?php echo $employe['tel'] ?></th>
        <th><?php echo $employe['ville'] ?></th>
        <th><?php echo $employe['address'] ?></th>
        <th><?php echo $employe['post'] ?></th>
        <th><a href="employe_single.php?id=<?php echo $employe['id']; ?>" class="btn btn-danger">Modifier</a></th>
        </tr>  
        <?php } ?>
  </tbody>
</table>
