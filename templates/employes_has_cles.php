<?php require_once '../controllers/employes_has_cles_script.php' ?>
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    ...
    <title>Liste des employés ayant une clé</title>
...
<h1>Liste des employés ayant une clé</h1>
<hr>

<!-- Si la requête est envoyée, un message de succès apparaît -->
<?php if(isset($_SESSION['success_two']) && !empty($_SESSION['success_two'])){ ?>
            <div class="alert alert-success alert-dismissible fade show">
            <?php echo $_SESSION['success_two']; ?>
            <?php unset($_SESSION['success_two']); ?>
...
<table class="table">
  ...
  <tbody>
        <tr>
        <?php foreach($employeHasCles as $employeHasCle){ ?>
        <th><?php echo $employeHasCle['id'] ?></th>
        <th><?php echo $employeHasCle['name'] ?></th>
        <th><?php echo $employeHasCle['firstname'] ?></th>  
        <th><?php echo $employeHasCle['numero_cle'] ?></th>
        </tr>  
        <?php } ?>
  </tbody>
</table>
