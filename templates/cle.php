 <?php require_once '../controllers/cle_script.php'; ?>
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<h1>Ajouter une clé</h1>
<hr>

<?php if(isset($success_five)){ ?>
  <div class="alert alert-success alert-dismissible fade show"> 
    La clé numéro <strong><?php echo $numCle ; ?></strong> est ajoutée avec succès !
...
<main>
  ...
  <div class="container">
    <div class="form-group">
      <form method="POST">
        <label for="numero_cle">Numéro clé</label>
        <input class="form-control" type="text" name="numero_cle" id="numero_cle">
        <?php if(isset($errors['numero_cle'])) { ?> 
          <div class="alert alert-danger"> <?php echo $errors['numero_cle'] ?>
            <button type="button" class="close" data-dismiss="alert" aria-label="close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
